...
//    private RestTemplate restTemplate = new RestTemplate();
    ...
    private HttpEntity<String> createMessage() {
    ...
    private String creatParams(InstanceEvent event, Instance instance){
        ...
        String parmas = "templateId=" + templateId +
                "&content=" + JSONUtil.toJsonStr(Util.getWeChatTemplate(title,"","",instance.getInfo().getValues().get("project-name")+"",instance.getStatusInfo().getDetails().get("message") + "")) +
